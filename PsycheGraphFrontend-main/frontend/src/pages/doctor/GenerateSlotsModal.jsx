...
export default function GenerateSlotsModal({ isOpen, onClose, doctorId }) {
    ...
    const fetchFee = async () => {
        ...
        try {
            const data = await DoctorService.getDoctorFee(doctorId);
            if (data && data.amount) {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (hasExistingFee) {
                await DoctorService.updateDoctorFee(doctorId, feePayload);
            } else {
                await DoctorService.setDoctorFee(doctorId, feePayload);
            }
            ...
            await DoctorService.generateAvailabilitySlots(doctorId, generationPayload);
            setSuccess(true);
            setTimeout(() => {
                setSuccess(false);
                onClose();
