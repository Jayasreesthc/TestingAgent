...
export default function ReceptionistAvailabilities() {
    ...
    // Derived list of assigned doctors (same logic as Appointments.jsx)
    ...
    const fetchSchedule = async (id) => {
        ...
        setError(null);
        try {
            const data = await DoctorService.getDoctorSchedule(id);
                            ...
                            <div className="relative flex flex-col md:flex-row md:items-center gap-8">
                                ...
                                <div className="flex-1 space-y-4">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        <div>
                                            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight">Pr. {selectedDoctor.full_name}</h2>
                                    ...
                                    <p className="text-base text-slate-300 font-medium leading-relaxed max-w-2xl border-l-2 border-primary-500/50 pl-6 italic">
                                        {selectedDoctor.metadata || "Specialized in General Psychiatry and Mental Wellbeing."}
                                    </p>
                                </div>
                            </div>
                        </div> */}
