...
export default function DoctorManageModal({ isOpen, onClose, doctorId, doctorName }) {
    ...
    const fetchInitialData = async () => {
        ...
        try {
            ...
            // Fetch Fee
            const feeData = await DoctorService.getDoctorFee(doctorId);
    ...
    const handleSaveFee = async () => {
        ...
        try {
            ...
            if (hasExistingFee) {
                await DoctorService.updateDoctorFee(doctorId, payload);
            } else {
                await DoctorService.setDoctorFee(doctorId, payload);
            }
            setHasExistingFee(true);
    ...
    const handleGenerateSlots = async () => {
        ...
        try {
            ...
            if (Number(slotData.fee) !== Number(feeAmount)) {
                ...
                if (hasExistingFee) await DoctorService.updateDoctorFee(doctorId, feePayload);
                else await DoctorService.setDoctorFee(doctorId, feePayload);
                setHasExistingFee(true);
                setFeeAmount(slotData.fee);
            }

            await DoctorService.generateAvailabilitySlots(doctorId, {
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="p-8 pb-4 flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-black text-[#062f3f] tracking-tight">Manage {doctorName}</h2>
